...
public class App {
        public static void main(String[] args) {
                 ...
                 */
                Jugador jugador1 = new Jugador(TipoTrabajador.Jugador, "Luis Suárez", new Date(1994, 1, 12), "Uruguay",
                                "Suarez",
                                Posicion.Delantero, 9,
                                Traspaso.SINSOLICITAR);
                Jugador jugador2 = new Jugador(TipoTrabajador.Jugador, "Gerard Piqué", new Date(1987, 2, 2), "España",
                                "Piqué",
                                Posicion.Defensa,
                                8,
                                Traspaso.SINSOLICITAR);
                Jugador jugador3 = new Jugador(TipoTrabajador.Jugador, "Thibaut Courtois", new Date(1992, 5, 11),
                                "Bélgica", "Courtois",
                                Posicion.Portero,
                                1, Traspaso.SINSOLICITAR);
                Jugador jugador4 = new Jugador(TipoTrabajador.Jugador, "Leonel Messi", new Date(1984, 5, 26),
                                "Argentina",
                                "Messi", Posicion.Medio_Campista, 10, Traspaso.SINSOLICITAR);
                Jugador jugador5 = new Jugador(TipoTrabajador.Jugador, "Stefano Alderete", new Date(2000, 8, 21),
                                "Peru", "Gonzalo",
                                Posicion.Aguatero, 0,
                                Traspaso.SINSOLICITAR);
                Jugador jugador6 = new Jugador(TipoTrabajador.Jugador, "Vinicious Junior", new Date(2000, 6, 21),
                                "Brasil", "Vini Jr",
                                Posicion.Delantero, 9,
                                Traspaso.SINSOLICITAR);
                Jugador jugador7 = new Jugador(TipoTrabajador.Jugador, "Van Dijk", new Date(1998, 6, 11),
                                "Paises Bajos", "Virgil",
                                Posicion.Defensa,
                                6666, Traspaso.SINSOLICITAR);
                Jugador jugador8 = new Jugador(TipoTrabajador.Jugador, "Lamine Yamal", new Date(2006, 9, 25), "España",
                                "Yamal",
